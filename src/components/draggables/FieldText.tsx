  ...
  return (
    <FieldBase id={id} fieldType={fieldType} index={index} label={label}>
      <input
        ...
        className="bg-background w-full rounded-[1rem] border-none p-[1.2rem] hover:cursor-grab text-[1.4rem] font-medium inset-shadow-[-5px_-5px_10px_0_#FFFFFF70,5px_5px_10px_0_#AEAEC020] outline-none"
        disabled={disabled}
      />
    </FieldBase>
  );
